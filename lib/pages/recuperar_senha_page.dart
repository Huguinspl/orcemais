...
class _RecuperarSenhaPageState extends State<RecuperarSenhaPage>
  ...
  Future<void> _enviarEmailRecuperacao() async {
        ...
        SnackBar(
          content: const Row(
            children: [
              ...
              SizedBox(width: 12),
              Expanded(child: Text('Por favor, informe um e-mail')),
            ],
          ),
    ...
    try {
      ...
      print('═══════════════════════════════════════');
      print('📧 Email: $email');
      print('⏱️  Horário: ${DateTime.now()}');
      print('Enviando solicitação ao Firebase...');

      // Envia e-mail de recuperação via Firebase Auth
      await FirebaseAuth.instance.sendPasswordResetEmail(email: email);

      // Log de sucesso
      print('✅ SUCESSO! Email de recuperação enviado pelo Firebase');
      print('📬 IMPORTANTE: Verifique:');
      print('   1. Caixa de entrada de: $email');
      print('   2. Pasta de SPAM/Lixo Eletrônico');
      print('   3. Aguarde até 10 minutos');
      print('═══════════════════════════════════════');
        ...
        SnackBar(
          content: const Column(
            ...
            children: [
              ...
              Text(
                '⚠️ Se não aparecer, verifique o SPAM',
                style: TextStyle(fontSize: 13),
              ),
            ],
          ),
      ...
      // Aguarda 2 segundos antes de voltar (para usuário ler a mensagem)
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      // Fecha o teclado ao clicar em qualquer parte da tela
      onTap: () {
        FocusScope.of(context).unfocus();
      },
      child: Scaffold(
