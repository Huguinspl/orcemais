...
class _AgendamentoAPagarPageState extends State<AgendamentoAPagarPage> {
  ...
  void initState() {
    ...
    if (agendamento != null) {
      ...
      _horaPagamento = TimeOfDay(hour: dataHora.hour, minute: dataHora.minute);

      // Carregar nome do fornecedor se disponível
      if (agendamento.clienteNome != null &&
          agendamento.clienteNome!.isNotEmpty) {
        _fornecedorController.text = agendamento.clienteNome!;
      }
    ...
    try {
      ...
      if (_agendamentoId != null) {
        ...
        final transacao = Transacao(
          ...
          categoria: _categoriaSelecionada ?? CategoriaTransacao.fornecedores,
          data: _dataPagamento!,
