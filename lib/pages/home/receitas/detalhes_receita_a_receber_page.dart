...
class DetalhesReceitaAReceberPage extends StatefulWidget {
  final Transacao transacao;

  const DetalhesReceitaAReceberPage({super.key, required this.transacao});

  @override
  State<DetalhesReceitaAReceberPage> createState() =>
      _DetalhesReceitaAReceberPageState();
}

class _DetalhesReceitaAReceberPageState
    extends State<DetalhesReceitaAReceberPage> {
  ...
  void _abrirEdicao() async {
    final resultado = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => NovaReceitaPage(transacao: _transacao, isFutura: true),
      ),
    );
  ...
  Future<void> _marcarComoRecebida() async {
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Receita recebida e registrada (${currencyFormat.format(_transacao.valor)})',
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    ...
    const corTema = Colors.teal;

    return Scaffold(
      appBar: AppBar(
        title: const Text('Receita a Receber'),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const Text('Marcar como Recebida'),
